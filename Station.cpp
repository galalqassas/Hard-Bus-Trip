...
const Queue<Passenger *> /*I removed the & here and add const in this function and in isEmpty function inside Queue*/
Station::getWaitingNpForward() const {
...
void Station::removePassengersInOneMinute(Station s, Bus *tempBus, Passenger *passenger, int numberOfPassengerToRelease) {
